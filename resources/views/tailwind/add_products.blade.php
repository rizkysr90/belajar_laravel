...
@section('content')
    <div class="bg-neutral  m-4 rounded-md p-4 mt-8">
        ...
        {!! Form::open(array('url' => url('products/store'), 'method' => 'post', 'class' => 'form-horizontal')) !!}
            ...
            <input type="text" id="name" name="product_name" placeholder="Masukkan nama produk" class="input w-full max-w-xs mb-4" />
            {!!Form::label('url_image', 'Url Gambar', array('class' => 'block mb-2')) !!}
            <input type="text" id="url_image" name="url_image" placeholder="Masukkan URL Gambar Produk" class="input w-full max-w-xs mb-4" />
            ...
            <input type="number" name="buy_price" id="buy_price" placeholder="(Ex): Rp5.000" class="input w-full max-w-xs mb-4" />
            {!!Form::label('sale_price', 'Harga Jual', array('class' => 'block mb-2')) !!}
            <input type="number" name="sale_price" id="sale_price" placeholder="(Ex): Rp5.000" class="input w-full max-w-xs mb-4" />
            ...
            <input type="text" id="description" name="description" placeholder="(Ex): Produk ini dibuat dari kedelai pilihan" class="input w-full max-w-xs mb-4" />
            <div>
